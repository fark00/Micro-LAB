...
; 0000 001F 
; 0000 0020 
; 0000 0021 // Alphanumeric LCD initialization
; 0000 0022 // Connections are specified in the
; 0000 0023 // Project|Configure|C Compiler|Libraries|Alphanumeric LCD menu:
; 0000 0024 // RS - PORTC Bit 0
; 0000 0025 // RD - PORTC Bit 1
; 0000 0026 // EN - PORTC Bit 2
; 0000 0027 // D4 - PORTC Bit 4
; 0000 0028 // D5 - PORTC Bit 5
; 0000 0029 // D6 - PORTC Bit 6
; 0000 002A // D7 - PORTC Bit 7
; 0000 002B // Characters/line: 16
; 0000 002C 
; 0000 002D init_ports();
	RCALL _init_ports
; 0000 002E init_timer();
	CALL _init_timer
...
; 0002 000C // OC0 Period: 65.28 ms Width: 6.656 ms
